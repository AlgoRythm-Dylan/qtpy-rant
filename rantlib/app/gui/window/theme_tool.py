...
from rantlib.app.gui.theme import *
from rantlib.app.gui.thread.themes import LoadThemesWorker
from rantlib.app.gui.parts.pg_theme_sample import ThemeSamplePage
...
class ThemeTool(Window):
    ...
    def change_theme(self):
        if(self.select_theme_combo.currentIndex() == -1):
            ...
            return
        self.theme_sample_page.apply_theme(self.theme_list[self.select_theme_combo.currentIndex()])
